"""
Prediction of smoking variable. Oversampling minority class.
"""
import pickle
import numpy as np
...
smoking = train_df[train_df['Smoking_binarized'] == 1]
smoking_df = pd.concat([smoking]*9, ignore_index=True)


train_df = pd.concat([train_df, smoking_df], ignore_index = True)
